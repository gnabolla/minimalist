...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-md mx-auto bg-white shadow-md rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>admin/create" class="space-y-6">
                <div>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                            class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">Create User</button>
                </div>
            </form>
        </div>
    </div>
